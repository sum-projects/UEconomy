...
public class GameEngine
{
    ...
    public GameEngine(GraphicsDeviceManager graphics)
    {
        _graphics = graphics;
    ...
    private void DrawGlobalStatsPanel()
    {
        ...
        int panelWidth = (int)(_graphics.GraphicsDevice.Viewport.Width * 0.24f); // ~24% szerokości ekranu
    ...
    private void HandleResourceButtonClick(Point mousePosition)
    {
        ...
        int panelX = _gridMarginX + _gridWidth * _cellSize + 20;
        int panelY = _gridMarginY;
        int panelWidth = (int)(_graphics.GraphicsDevice.Viewport.Width * 0.24f);
        int panelHeight = _gridHeight * _cellSize;
